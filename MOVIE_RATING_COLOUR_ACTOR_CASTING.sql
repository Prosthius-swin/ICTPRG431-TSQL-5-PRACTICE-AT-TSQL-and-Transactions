...
CREATE TABLE ACTOR9468 (
  ACTORNO    INT
, FULLNAME   VARCHAR(100) CHECK (FULLNAME IS NOT NULL)
, GIVENNAME  VARCHAR(100) CHECK (GIVENNAME IS NOT NULL)
, SURNAME    VARCHAR(100) CHECK (SURNAME IS NOT NULL)
, GENDER     NVARCHAR(1)  CHECK (LEN(GENDER) = 1)
, BIRTHDATE  DATE
, IMDBID     VARCHAR(20)
